...
<canvas id="myCanvas" width="700" height="500" style="z-index:1000;border:1px solid #000000" ></canvas>
...
function get_random_color_gray() {
    var h = Math.floor(Math.random() * 120) + 120
    var s = 50
    var l = 50
    return 'hsl(' + h + ',' + s + '%,' + l + '%)';
}
function get_random_color_white() {
    var l = 0
    var s = 0
    var h = Math.floor(Math.random() * 120) + 240
    return 'hsl(' + h + ',' + s + '%,' + l + '%)';
}
